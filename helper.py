...
# fetch_medal_tally by year and country
...
#Function to remove duplicates and it returns the total medals
def medal_tally(df):
...
#Most successful country-wise athletes
# Top athletes
