...
st.sidebar.image("https://www.thoughtco.com/thmb/sNrHJEJXn9foBOSU5CSIZ4Mp-9Y=/2000x1333/filters:fill(auto,1)/GettyImages-958024924-5b8c1ad946e0fb0050f27628.jpg")
...
if user_menu == 'Overall Analysis':
    ...
    with col3:
        st.header("Athletes")
        st.title(athletes)
    # Nations over time graph
    nations_over_time = helper.data_over_time(df,'region')
    fig = px.line(nations_over_time, x="Edition", y="region")

    # Customize layout to show gridlines
    fig.update_layout(
...
# Top country_wise athletes
    st.title("Top 10 athletes of " + selected_country)
    top10_df = helper.top_athletes(df,selected_country)
    st.table(top10_df)
